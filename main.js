$(document).ready(function() {
    ...
    $('#CodeButton').click(function() {
        if (Code.val() == localStorage.getItem("hediye")) {
            $('#arabaSpecial').fadeIn(500).css({
                'background': 'url(http://i.hizliresim.com/bQqM1G.png) repeat 0px 1px',
            ...
            $('#arabaSpecial:hover').css({
                ...
                'background': 'url(http://i.hizliresim.com/bQqM1G.png) repeat 165px 1px'
            });
        }
    });
    /*Hediye Kodu - Ovarida*/
    ...
    $('#NightinGale').click(function() {
        $('#canvas').css({
            'background': 'url(http://i.hizliresim.com/q9a1Jd.jpg)'
        });
        $('#canvas2').css({
            'background': 'url(http://i.hizliresim.com/nYqByB.jpg)'
        });
        $('#karart').css({
            'display': 'inline'
        });
    ...
    $('#SandPudding').click(function() {
        ...
        $('#canvas').css({
            'background': 'url(http://i.hizliresim.com/vYB1Gv.jpg)'
        });
        $('#canvas2').css({
            'background': 'url(http://i.hizliresim.com/vYB1Gv.jpg)'
        });
    ...
    $('#SnowWhite').click(function() {
        ...
        $('#canvas').css({
            'background': 'url(http://i.hizliresim.com/nY897R.jpg)  '
        });
        $('#canvas2').css({
            'background': 'url(http://i.hizliresim.com/nY897R.jpg)  '
        });
    ...
    $("#sliderPo").hover(function() {
        ...
        /*
$( "#sliderContainer" ).mousemove(function( event ) { var pageCoords = "( " + event.pageX + ", " + event.pageY + " )";
  var clientCoords = "( " + event.clientX + ", " + event.clientY + " )";
  var yon = event.clientX;;
  $('#mousepoint').text(yon);
  $('#mousepoint2').text(clientCoords);
  ...
  'left':yon+'px'
    ...
    $('#arabaSpecial').click(function() {
        if (Code.val() == localStorage.getItem("hediye")) {
            $('#oyuncu').css({
                'background': 'url(http://i.hizliresim.com/onMWNq.png) repeat 0px 1px'
            });
